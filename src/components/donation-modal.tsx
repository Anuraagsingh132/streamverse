...
const DonationModal: React.FC<DonationModalProps> = ({ isOpen, onClose, upiId }) => {
  ...
  // Countdown Timer to 27th Sept 2025
  useEffect(() => {
      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-5 pt-8">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <span className="font-semibold">StreamVerse</span> for you. To keep
            it running smoothly, add new features, and cover essential costs, I
            rely on the generosity of our community.
          </p>

          <p className="text-sm sm:text-base leading-relaxed text-center text-red-600 dark:text-red-400 font-semibold">
            ⚠️ The domain is going to expire. Please bookmark <br />
            <a
