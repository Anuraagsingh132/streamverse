      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-5 pt-8"> {/* Increased pt for logo space */}
          ...
          <div className="text-sm text-muted-foreground leading-relaxed">
            The domain is going to expire. Please bookmark the new links to continue using StreamVerse:
            <div className="mt-3 space-y-2">
                <code className="block break-all rounded bg-secondary/30 px-2 py-1 font-mono text-xs">
                    https://streamverse-vit.netlify.app/home
                </code>
                <code className="block break-all rounded bg-secondary/30 px-2 py-1 font-mono text-xs">
                    https://streamverse-vit.vercel.app
                </code>
            </div>
          </div>

          {/* Countdown Timer */}
          <div className="w-full rounded-lg border border-destructive/50 bg-destructive/10 p-3 text-destructive dark:text-red-400">
            <p className="mb-2 text-xs font-semibold uppercase tracking-wider">Domain Expires In:</p>
          ...
          <div className="w-full space-y-3 text-center mt-2">
            <p className="text-xs font-medium text-muted-foreground">
              Help cover server costs via UPI:
            </p>
