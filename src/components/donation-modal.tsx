      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-5 pt-8">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            As a student, I&apos;ve poured my passion into creating StreamVerse for you. 
            To keep it running smoothly, add new features, and cover essential costs, 
            I rely on the generosity of our community. <br /><br /> 
            Your support, no matter the amount, is vital for the future of StreamVerse. 
            Please consider a contribution if you find value in what we offer. 
            Thank you for helping out!
          </p>

          {/* --- Warning Section --- */}
          <div className="w-full rounded-md bg-yellow-100 dark:bg-yellow-900/40 p-3 text-sm border border-yellow-400 text-yellow-800 dark:text-yellow-200">
            ⚠️ The domain is going to expire soon. Please bookmark{' '}
            <a
